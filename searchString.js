...
function getDocStats(fileContent) {
	...
	let topFive = wordList.slice(0, 6)
	// return the bottom five words
	let bottomFive = wordList.slice(-6, wordList.length)

	// write the values to the page
	ulTemplate(topFive, document.getElementById('mostUsed'))
	ulTemplate(bottomFive, document.getElementById('leastUsed'))
